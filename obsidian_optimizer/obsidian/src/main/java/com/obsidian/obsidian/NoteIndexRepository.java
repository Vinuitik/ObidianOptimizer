...
public class NoteIndexRepository {
    ...
    // Called at startup. Compares disk state to DB, inserting/updating changed
    // notes and deleting notes that no longer exist on disk.
    // Also keeps note_links consistent for every changed file.
    ...
    // Wipe both tables and re-sync from scratch (used on vault path change).
    ...
    // Returns one page of review-due notes. Uses limit+1 trick to detect hasMore
