...
Supersedes the resource half of `LINK_SNIFFER_AGENT_ARCH.md` (network-sniffing is out;
we capture the rendered DOM the user can already see) and unifies `INGEST_AGENT_ARCH.md`
